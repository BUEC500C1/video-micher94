...
def readtweets(searchterm):
    ...
    if searchterm[0] == '@':
        ...
        for tweets in api.user_timeline(screen_name=sn, result_type = 'recent', tweet_mode = 'extended', count = 1):
	...
	# leveraged https://stackoverflow.com/questions/38872195/tweepy-exclude-retweets for how to exclude retweets from twitter list and eliminate duplicates
        for tweets in api.search(q=searchterm, lang = 'en', result_type = 'recent', count = 1):
